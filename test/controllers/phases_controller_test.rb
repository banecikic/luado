...
class PhasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phase" do
    assert_difference('Phase.count') do
      post phases_url, params: { phase: { content: @phase.content, phase_title: @phase.phase_title, project_id: @phase.project_id } }
    end
  ...
  test "should update phase" do
    patch phase_url(@phase), params: { phase: { content: @phase.content, phase_title: @phase.phase_title, project_id: @phase.project_id } }
