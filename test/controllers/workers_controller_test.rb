...
class WorkersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create worker" do
    assert_difference('Worker.count') do
      post workers_url, params: { worker: { name: @worker.name, price: @worker.price, service: @worker.service } }
    end
  ...
  test "should update worker" do
    patch worker_url(@worker), params: { worker: { name: @worker.name, price: @worker.price, service: @worker.service } }
